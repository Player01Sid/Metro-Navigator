...
int main()
{
    ...
    addStation(metroMap, "Station B", 2); // Line 2
    addStation(metroMap, "Station C", 3); // Line 3
    addStation(metroMap, "Station D", 1); // Line 1
    addStation(metroMap, "Station E", 2); // Line 2
    addStation(metroMap, "Station F", 3); // Line 3
